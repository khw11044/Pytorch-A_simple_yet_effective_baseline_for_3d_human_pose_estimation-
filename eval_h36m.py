...
config.BATCH_SIZE = 1
config.morph_model = 'models/model_skeleton_morph_S1_gh_mine.pt'
config.load_model = 'models/model_lifter_h36m_fusion.pt'  
# model_lifter
...
config.datafile = data_folder + 'alphapose_2d3dgt_img_h36m.pickle' # 'mpii_all_data.pickle'
